...
SplitData prepare_split_data(const arma::vec &y, const arma::mat &x, arma::Col<int> &deltaini_input,
...
arma::Col<int> combine_results(const std::vector<arma::Col<int> > &results,
...
arma::Col<int> model_selection_strategy(const arma::vec &y, const arma::mat &x, int niter, int thinning, int burnin,
