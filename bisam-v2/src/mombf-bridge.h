...
namespace MombfBridge {
    ...
    inline void countConstraints(int *nconstraints,
    ...
    inline arma::Col<int> modelSelectionGibbsCI(const arma::vec &SpostModeini,
    ...
    inline arma::vec initParameters(const arma::vec &y, const arma::mat &x, int family,
                                    InitparType initpar) {
        int n = y.n_elem;
        int p = x.n_cols;
    ...
    inline std::pair<arma::vec, int> getthinit(const arma::vec &y, const arma::mat &x, int family,
    ...
    inline arma::Col<int> modelSelection(const arma::vec &y, const arma::mat &x, int niter, int thinning, int burnin,
    ...
    inline void rnlpPost_lm(double *ans, int niter, int burnin, int thinning, double *y, double *x, int n, int p, int r,
